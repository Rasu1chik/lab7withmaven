...
public class Info extends Command{
    ...
    public void execute(String args) throws IllegalArguments {
        ...
        stringBuilder.append("Сведения о коллекции: \n")
                .append(ConsoleColors.toColor("Тип: ", ConsoleColors.GREEN) + collectionManager.getCollectionType() + "\n")
                .append(ConsoleColors.toColor("Количество элементов: ", ConsoleColors.GREEN) + collectionManager.getCollectionSize() + "\n")
